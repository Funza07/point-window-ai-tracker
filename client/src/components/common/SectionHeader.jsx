...
export default function SectionHeader({ title, sub, action, delay = 0 }) {
  ...
  return (
    <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-end", flexWrap:"wrap", gap:8, marginBottom:16, opacity: vis ? 1 : 0, transform: vis ? "translateX(0)" : "translateX(-8px)", transition:"all 0.4s ease" }}>
      <div>
