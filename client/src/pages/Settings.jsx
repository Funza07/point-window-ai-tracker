  ...
  return (
    <div className="page-enter" style={{ paddingBottom: isMobile ? 90 : 0 }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: isMobile ? 12 : 13, color: "#7a6b84", margin: 0 }}>Personalize your Point Window experience</p>
      </div>
